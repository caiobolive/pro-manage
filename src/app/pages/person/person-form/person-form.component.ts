...
export class PersonFormComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  private createPerson(): void {
    ...
    this.personService.create(this.person).subscribe({
      next: () => {
        this.toast.success('Employee cadastrado com sucesso', 'Cadastro');
  ...
  private updatePerson(): void {
    ...
    this.personService.update(this.person.id, this.person).subscribe({
      next: () => {
        this.toast.success('Employee atualizado com sucesso', 'Atualização');
        this.router.navigate(['person']);
        this.isSaving = false;
      },
      error: (ex) => {
  ...
  addRoutinesToPerson(): void {
    ...
    this.personService
      ...
      .subscribe({
        next: () => {
          this.toast.success('Routines adicionadas com sucesso', 'Atualização');
          this.findPersonRoutines();
        },
        error: (ex) => {
          this.handleErrors(ex);
  ...
  addTasksToPerson(): void {
    ...
    this.personService
      ...
      .subscribe({
        next: () => {
          this.toast.success('Tasks adicionadas com sucesso', 'Atualização');
          this.findPersonTasks();
        },
        error: (ex) => {
          this.handleErrors(ex);
  ...
  addAssignmentsToPerson(): void {
    ...
    this.personService
      ...
      .subscribe({
        next: () => {
          this.toast.success(
            'Attributions adicionadas com sucesso',
            'Atualização'
          );
          this.findPersonAssignments();
        },
